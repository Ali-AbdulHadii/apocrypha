...
| Page transition (`pageMotion`) | tween | in 260ms, out 120ms, `[0.16, 1, 0.3, 1]`, `opacity 0 -> 1`, `y 8 -> 0 -> -6` |
...
| Nav pill | spring | stiffness 360, damping 34, `layoutId="nav-pill"` |
| Segmented pill | spring | stiffness 420, damping 34, `layoutId` per `idPrefix`; settings tabs share it |
